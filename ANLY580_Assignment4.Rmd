...
## Muhammad	Huzaifa
The wordcloud library will provide the wordcloud function to which one can pass arguments.For a simple illustration:

Let x be the collection of words and g  is the collection of corresponding frequencies of those words.
...
g<-c( 78,  40, 172 ,147, 213, 101, 217,  29, 149, 174, 213, 166, 265 ,215,56, 109,80,   260)

wordcloud(x,g,scale=c(4,1),Inf,random.order=FALSE)
